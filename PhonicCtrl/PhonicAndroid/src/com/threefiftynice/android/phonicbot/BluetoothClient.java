...
public class BluetoothClient {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(PhonicBot.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(PhonicBot.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(PhonicBot.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PhonicBot.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PhonicBot.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(PhonicBot.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PhonicBot.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
